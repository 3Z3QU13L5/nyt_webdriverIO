...
describe('Discover On the Market Articles Collection', () => {
    ...
    it('Header should be present and be clickable', () => {
        var collectionHeader = $(findAHome.selector.collectionHeader.onTheMarket);
    ...
    it('The Header should be the same kicker of each articles', () => {
        var collectionHeader = $(findAHome.selector.collectionHeader.onTheMarket).getText();
        for(ind = 1; ind<=articlesAmount; ind++){
            var articleKickers = $(findAHome.pinPointArticle(findAHome.selector.articles.kicker, 2, ind)).getText();
    ...
    it('Article Picture should be there and be clickable', () => { 
        for(ind = 1; ind<=articlesAmount; ind++){
            var articlePictures = $(findAHome.pinPointArticle(findAHome.selector.articles.picture, 2, ind));
    ...
    it('Article Picture should redirect to the corresponding findAHome', () => {
        for(ind = 1; ind<=articlesAmount; ind++){
            var headline = $(findAHome.pinPointArticle(findAHome.selector.articles.headline, 2, ind)).getText();
            var picture = $(findAHome.pinPointArticle(findAHome.selector.articles.picture, 2, ind));
    ...
    it('Article Picture Byline should be present', () => {
        for(ind = 1; ind<=articlesAmount; ind++){
            var articlePictureBylines = $(findAHome.pinPointArticle(findAHome.selector.articles.pictureByLine, 2, ind));
    ...
    it('Article Headline should be there and be clickable', () => {
        for(ind = 1; ind<=articlesAmount; ind++){
            var articleHeadlines = $(findAHome.pinPointArticle(findAHome.selector.articles.headline, 2, ind));
    ...
    it('Article Headline should redirect to the corresponding findAHome', () => {
        for(ind = 1; ind<=articlesAmount; ind++){
            var headline = $(findAHome.pinPointArticle(findAHome.selector.articles.headline, 2, ind));
    ...
    it('Article Kicker should be there', () => {
        for(ind = 1; ind<=articlesAmount; ind++){
            var articleKicker = $(findAHome.pinPointArticle(findAHome.selector.articles.kicker, 2, ind));
    ...
    it('Article Summary should be present', () => {
        for(ind = 1; ind<=articlesAmount; ind++){
            var articleSummary = $(findAHome.pinPointArticle(findAHome.selector.articles.summaries, 2, ind));
    ...
    it('Article Byline should be present', () => {
        for(ind = 1; ind<=articlesAmount; ind++){
            var articleBylines = $(findAHome.pinPointArticle(findAHome.selector.articles.byLines, 2, ind));
    ...
    it('There should be ' + articlesAmount + ' articles by collection', () => {
        var articleCollectionSize = $$(findAHome.pinPointArticle(findAHome.selector.articles.articles, 2, ind)).length;
